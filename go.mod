...
require (
	...
	// fix for: https://github.com/hashicorp/vault/issues/31461
...
replace github.com/tencentcloud/tencentcloud-sdk-go => github.com/tencentcloud/tencentcloud-sdk-go v1.0.162
